...
func Ejecutar(ctx context.Context, opts Opciones) error {
	...
	srv := &http.Server{
		...
		// Sin WriteTimeout: en E0 una solicitud puede pasar varios segundos
		// esperando turno en la cola, y eso es justamente lo que se quiere
		// medir. Un WriteTimeout corto cortaria respuestas validas y borraria
